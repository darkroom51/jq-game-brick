...
function InfoPages() {
    ...
    this.pageInstruction = $('<div class="page-level-ok"><div class="game-instruction">' +
        '<p>Catch good ones <img src="img/mh1.svg" alt="good ones"><img src="img/mh2.svg" alt="good ones"><img src="img/mh3.svg" alt="good ones"></p>' +
        '<p>Avoid bad ones &nbsp;&nbsp;&nbsp;<img src="img/mh6.svg" alt="bad ones"><img src="img/mh7.svg" alt="bad ones"><img src="img/mh8.svg" alt="bad ones"></p>' +
